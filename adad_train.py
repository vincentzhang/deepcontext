...
if __name__ == '__main__':
  ...
  if 'solver' not in locals():
    ...
    ut.mkorender('solver_cv_adad_mko.prototxt', solver_file,
                 base_lr=1,
                 outdir=deepcontext_config.out_dir,delta=1e-8,
                 weight_decay=1e-5, momentum=0.9,
                 fnm='network_conv_sketch_no_bn_no_freeze.prototxt',
    ...
    for curstep in xrange(num_iter+1):
      ...
      if curstep % 105 == 0: # 1 epoch
        ...
        plt.savefig(outdir +  '_step_' + str(curstep) + '_conv1_filter.png',bbox_inches='tight')
        plt.close()
