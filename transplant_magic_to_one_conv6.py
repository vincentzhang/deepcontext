...
old_model_def = "/usr/work/data/deepcontext_o/magic/network_fc6_no_bn.prototxt"
net = caffe.Net(old_model_def,
              '/usr/work/data/deepcontext_o/outputmodel.caffemodel',
             caffe.TEST)
params = ['fc6']
...
model_conv_def = "/usr/work/data/deepcontext_o/magic/network_conv_sketch_no_bn_one_conv6.prototxt"
...
for pr, pr_conv in zip(params, params_full_conv):
    ...
    print "shape of "+pr+"is ",fc_params[pr][0].shape
    conv_params[pr_conv][1][...] = fc_params[pr][1]
    print "shape of "+pr_conv+"is ",conv_params[pr_conv][0].shape
...
conv_weight_file = '/usr/work/data/deepcontext_o/magic/sketch_no_bn_one_conv6.caffemodel'
